...
import Vue from 'vue'
import UiBody from './ui-body/ui-body.vue'
Vue.component('ui-body', UiBody);
import UiContainer from './ui-container/ui-container.vue'
Vue.component('ui-container', UiContainer);
import UiRow from './ui-row/ui-row.vue'
Vue.component('ui-row', UiRow);
import UiColl from './ui-coll/ui-coll.vue'
Vue.component('ui-coll', UiColl);
