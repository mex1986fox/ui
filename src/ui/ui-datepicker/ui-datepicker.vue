<template>
    <div class="ui-datepicker">
        <ui-text
            ...
            :caption="dCaption"
            :readonly="true"
            :value="dSelectDate" @onFocus="isFocus" @onBlur="isBlur">
        </ui-text>
...
export default {
    data(){
        return{
            ...
            dSelectDate: "",
            dDate: new Date(),
            dMouths: [{id:"01",name:"Январь",leapDays:31,days:31},
    ...
    methods:{
        ...
        sumDays(year, mouths){
           return this.year%4==0 ?
            this.dMouths[mouths].leapDays : 
            this.dMouths[mouths].days;
        },
        clickLeft(){
            ...
            this.dDate = new Date(prevYear,prevMouth,this.sumDays(prevYear, prevMouth));
        },
        clickRight(){
            let prevMouth=this.dDate.getMonth()+1;
            let prevYear=this.compYear;
        ...
        clickNumber(number){
            this.dSelectDate=this.compYear+"-"+this.compMouths.id+"-"+(number>9?number:"0"+number);
            this.dFocus=false;
        }
    },
    computed:{
        compMouths(){
            return this.dMouths[this.dDate.getMonth()];
        },
        compYear(){
        ...
        compNumberDay(){
            ...
            let nDay= new Date(prevYear,prevMouth,this.sumDays(prevYear, prevMouth)).getDay();
            return nDay;
